...
let's make powerpoint figure
```{r}
ppt1 = p1 + theme(text = element_text(size = 20))  + theme(plot.title = element_text(size = 26))
ppt2 = p3 + theme(text = element_text(size = 20))  + theme(plot.title = element_text(size = 26))  
ppt3 = p7 + theme(text = element_text(size = 20))    + theme(plot.title = element_text(size = 26))
ppt4 = p8 + theme(text = element_text(size = 20))    + theme(plot.title = element_text(size = 26))
ppt5 = p11 + theme(text = element_text(size = 20))    + theme(plot.title = element_text(size = 26))
ppt6 = p12 + theme(text = element_text(size = 20))    + theme(plot.title = element_text(size = 26))

pptFig =  cowplot::plot_grid(ppt1, ppt2,  ppt4, ppt3, ppt6, ppt5,   ncol=2)
